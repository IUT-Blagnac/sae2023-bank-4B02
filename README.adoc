...
| 2       | Guichetier    | CRUD Prélèvement        | C                       |            |            |Ahmad D     |
| 2       | Guichetier    | CRUD Prélèvement        | R                       |            |            |Ahmad D     |
| 2       | Guichetier    | CRUD Prélèvement        | U                       |            |            |Ahmad D     |
| 2       | Guichetier    | CRUD Prélèvement        | D                       |            |            |Ahmad D     |
