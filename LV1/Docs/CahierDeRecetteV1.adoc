...
5+|
^|ID ^|Action ^|Comportement attendu ^|Pré-conditions ^|Résultat
^|All_G_C.1 ^|Cliquer sur le bouton "Nouvel employé". ^|La fenêtre de création des employés s'ouvre. ^| aucune ^|OK
...
>|Titre 4+|Consultation des informations d'un employé
>|Objectif 4+| Vérifier qu'il est possible de consulter les informations d'un employé

5+|
^|ID ^|Action ^|Comportement attendu ^|Pré-conditions ^|Résultat
^|All_G_C.1 ^|Cliquer sur le bouton "Info Employé". ^|La page des informations de l'employé s’affiche. ^| Un employé actif est sélectionné ^|OK
...
^|ID ^|Action ^|Comportement attendu ^|Pré-conditions ^|Résultat
^|All_G_C.3 ^|Cliquer sur le bouton "Modifier employé". ^|La fenêtre de modification des données de l'employé s'ouvre. ^|L'employé est sélectionné ^|OK
^|All_G_C.4 ^|Modifier les champs souhaités et confirmer. ^|Retour sur les informations de l'employé. L'employé est modifié. ^|La fenêtre modifier employé est active ^|OK
...
5+|
^|ID ^|Action ^|Comportement attendu ^|Pré-conditions ^|Résultat
^|All_G_C.1 ^|Cliquer sur le bouton "Supprimer". ^|La fenêtre de suppression d'employés s'ouvre. ^| La fenêtre de suppression d'employés est active ^|OK
^|All_G_C.2 ^|Compléter les champs spécifiés et valider. ^|Un nouveau client est créé. ^|aucune ^|OK
